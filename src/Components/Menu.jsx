...
const Menu = (props) => {
  ...
  return (
    <div className='text-white rounded-lg h-full bg-gray-200 hover:bg-gray-300 md:w-full md:flex md:flex-col '>
        ...
        <DialogContent>
          ...
          <table className="table table-dark table-hover table-bordered table-striped ">
            <thead className='table-head'>
              <tr className='text-lg'>
                ...
                <th className='text-center'>
                    <span className='hover:text-green-300  cursor-pointer'>A</span>
                    <span className='hover:text-green-300  cursor-pointer'>d</span>
                    <span className='hover:text-green-300  cursor-pointer'>j</span>
                    <span className='hover:text-green-300  cursor-pointer'>u</span>
                    <span className='hover:text-green-300  cursor-pointer'>s</span>
                    <span className='hover:text-green-300  cursor-pointer'>t </span>
                    <span className='hover:text-green-300  cursor-pointer'>Q</span>
                    <span className='hover:text-green-300  cursor-pointer'>T</span>
                    <span className='hover:text-green-300  cursor-pointer'>Y...</span>
            ...
            <tbody>
                      <tr>
                        ...
                        <td>
                           <div className="flex flex-row justify-center px-2 items-center w-full">
                            <button><span className='px-3 py-1  text-center font-bold text-lg bg-gray-900 border-2 border-white active:bg-gray-500 ' onClick={()=>setCount((count>=0)? (count=count+1):(count=count-1))}>+</span></button>
                            <span className='px-2 avtive:bg-green-600 bg-red-800'>{count}</span>
                            <button><span className='px-3 py-1  text-center font-bold text-lg bg-gray-900 border-2 border-white active:bg-gray-500 ' onClick={()=> setCount((count>=1)? (count=count-1):(count=0))}>-</span></button>
                           </div>
                        </td>
         ...
         {/*  */}
          ...
          <div className="w-full text-center">
             <div className="btn m-2 p-2 bg-orange-400 hover:bg-orange-600 active:bg-orange-800 text-center px-5 text-white hover:text-white hover:text-lg" onClick={()=> addItems(props.data,count)} >Confirm Order</div>
          </div>
          </div>
        </DialogContent>
       </Dialog>
